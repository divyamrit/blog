    ...
    <section class="grid grid-cols-2 font-jetMono sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 bg-green-100 dark:bg-cyan-500 gap-3 lg:gap-28 sm:py-5 md:py-8 lg:py-10 xl:py-14 py-8 rounded-3xl shadow justify-items-center">
      <a href="space.html" class="flex flex-col w-11/12 items-center cursor-pointer">
        <div class="w-11/12 sm:p-5 p-3 hover:bg-opacity-100 flex shadow items-center bg-gradient-to-r bg-opacity-70 bg-emerald-300 dark:from-blue-800 dark:to-indigo-600 rounded-xl">
          ...
          <div class="hidden w-full sm:flex-col text-white text-2xl sm:flex">
            <h1 class="ml-auto -mt-2 w-max bg-white opacity-80 px-1 rounded-md  text-black sm:text-xs md:text-sm lg:text-xl">
              22nd Sep 2021
            </h1>
            <h1 class="sm:text-3xl md:text-5xl text-emerald-900 dark:text-white">
              Space
            </h1>
            <p class="mt-2 ml-0.5 sm:text-lg md:text-lg dark:text-black text-green-600 line-clamp-2 md:line-clamp-4">
             Lorem ipsum dolor, sit amet consectetur adipisicing elit. Earum laborum, atque quis aut ducimus, placeat voluptatum numquam distinctio rerum nemo cum repudiandae voluptatibus quisquam minus recusandae. Qui excepturi nam recusandae.
            </p>
          </div>
        </div>
      </a>
